...
var hasClass = classListEnabled ? function __classListHasClass (el, className) {
...
var _addClass = classListEnabled ? function __classListAddClass (el, className) {
  el.classList.add(className);
} : function __polyfillAddClass (el, className) {
  if( !hasClass(el, className) ) el.className += ' ' + className;
};

var _removeClass = classListEnabled ? function __classListRemoveClass (el, className) {
...
AddressTypeahead.prototype.bind = function _protoAddressTypeaheadBind (input_el, options) {
  ...
  function _selectAddress (address) {
    ...
    if( try_search_value && try_search_predictions ) {
  ...
  if( input_el.value ) __onInput();
    ...
    __trySearches(
      ...
      function __onTrySearchMatch (predictions_data, try_search) {
        ...
        try_search_predictions = predictions_data;
